<x-admin-layout title="Edit User">
    <div class="max-w-3xl mx-auto">
        ...
        $selectedElectives = old('elective_subjects', $user->electiveSubjects->pluck('id')->toArray());
        ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Password <span
                                class="text-gray-400 font-normal">(kosongkan jika tetap)</span></label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400"><i
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t">
                    ...
                    <button type="submit"
                        class="inline-flex items-center gap-2 bg-green-600 text-white font-semibold px-6 py-2.5 rounded-lg hover:bg-green-700 shadow"><i
                            class="fa-solid fa-floppy-disk"></i> Update User</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        (function() {
            ...
            function toggle() {
                box.style.display = (role.value === 'siswa') ? '' : 'none';
            }
            if (role && box) {
                toggle();
