<x-admin-layout title="Manajemen User">
    <div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
            ...
            <a href="<?= route('admin.users.create') ?>" class="inline-flex items-center justify-center gap-2 bg-green-600 text-white font-semibold px-5 py-2.5 rounded-lg shadow hover:bg-green-700 transition">
