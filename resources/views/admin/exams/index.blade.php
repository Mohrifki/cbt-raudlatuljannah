                    ...
                    @forelse ($exams as $exam)
                        ...
                        <tr class="hover:bg-gray-50 align-top">
                            ...
                            <td class="p-3 border text-center whitespace-nowrap space-x-2">
                                <a href="<?= route($rp . '.exams.questions', $exam) ?>"
                                ...
                                <a href="<?= route($rp . '.exams.edit', $exam) ?>"
                                ...
                                <form action="<?= route($rp . '.exams.destroy', $exam) ?>" method="POST" class="inline"
