<x-admin-layout title="Tambah Mapel">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-green-600 to-emerald-500 px-6 py-5 flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-white font-bold text-lg">Tambah Mata Pelajaran</h2>
                    <p class="text-green-50 text-sm">Tentukan mapel wajib atau pilihan</p>
                </div>
            </div>
            ...
            <form action="<?= route('admin.subjects.store') ?>" method="POST" class="p-6 space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" value="<?= old('name') ?>" class="w-full pl-10 border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500" placeholder="Contoh: Matematika Wajib">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="code" value="<?= old('code') ?>" class="w-full pl-10 border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500" placeholder="Contoh: MTK-01">
                        </div>
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t">
                    ...
                    <button type="submit" class="inline-flex items-center gap-2 bg-green-600 text-white font-semibold px-6 py-2.5 rounded-lg hover:bg-green-700 shadow"><i class="fa-solid fa-floppy-disk"></i> Simpan Mapel</button>
                </div>
            </form>
        </div>
    </div>
