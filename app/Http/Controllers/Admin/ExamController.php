...
class ExamController extends Controller
{
  ...
  public function questions(Request $request, Exam $exam)
  {
    ...
    $totalForSubject = Question::where('subject_id', $exam->subject_id)->count(); // utk diagnosa
  ...
  public function syncQuestions(Request $request, Exam $exam)
  {
    ...
    return redirect()->route('admin.exams.questions', $exam)->with('success', count($ids) . ' soal disimpan ke paket ujian.');
  }
